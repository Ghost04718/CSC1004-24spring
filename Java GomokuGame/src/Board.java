...
//The Board class is serializable to realize the function to sava and load.
public class Board implements Serializable {
    ...
    //Judge whether the place is on board.
    private boolean onBoard(int col, int row) {
        return 0 <= col && col < size && 0 <= row && row < size;
    }

    //Judge whether the position is a valid position, on board and is empty.
